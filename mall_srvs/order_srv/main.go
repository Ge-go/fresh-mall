...
import (
	...
	"mall_srvs/order_srv/initialize"
	"mall_srvs/order_srv/proto"
	"mall_srvs/order_srv/srv_config"
)
...
func main() {
	...
	zap.S().Infof("order_srv is running,the ip is %v port is %v",
	...
	go func() {
		...
		if err != nil {
			panic("failed to start order_srv." + err.Error())
		}
	}()
